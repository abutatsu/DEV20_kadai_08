...
<head>
    ...
    <script src="js/jquery.simpleTicker.js"></script>
		...
		<script src="http://bootstrap3.cyberlab.info/bootstrap/assets/js/docs.min.js"></script>
    ...
    <div class="main_nav">
            <div class="left_nav">
                ...
                <ul id="nav5" style="margin:initial;">
                    <li><a href="../kadai_08/index.php">PLAYER</a></li>
                    <li><a href="../kadai_08/transfer.php">TRANSFER LIST</a></li>
                </ul>
            </div>
            <div class="userinfo">
                <img src="<?=$pImg?>" alt="">
