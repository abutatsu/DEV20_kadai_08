...
$age = "TIMESTAMPDIFF(YEAR, `u_birth`, CURDATE())";

//2．データ登録SQL作成 //ここにカラム名を入力する
$sql =  "UPDATE arsenal_user_table SET u_name=:u_name, u_birth=:u_birth, u_age=$age, u_player=:u_player,
...
$stmt->bindValue(':u_birth', $u_birth, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
